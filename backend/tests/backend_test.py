...
DB_NAME = os.environ.get('DB_NAME', 'clubmanagement')

ADMIN = {'email': os.environ.get('ADMIN_EMAIL', 'admin@clubmanager.local'), 'password': os.environ.get('ADMIN_PASSWORD', 'admin123')}
